...
from nciia.api.routes.tracker import router as tracker_router
from nciia.api.routes.osint_intel import router as osint_intel_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(tracker_router,      tags=["Canary Tracker"])
    app.include_router(osint_intel_router)
